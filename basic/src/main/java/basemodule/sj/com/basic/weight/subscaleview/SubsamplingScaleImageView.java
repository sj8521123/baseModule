...
package basemodule.sj.com.basic.weight.subscaleview;
...
import basemodule.sj.com.basic.weight.subscaleview.decoder.CompatDecoderFactory;
import basemodule.sj.com.basic.weight.subscaleview.decoder.DecoderFactory;
import basemodule.sj.com.basic.weight.subscaleview.decoder.ImageDecoder;
import basemodule.sj.com.basic.weight.subscaleview.decoder.ImageRegionDecoder;
import basemodule.sj.com.basic.weight.subscaleview.decoder.SkiaImageDecoder;
import basemodule.sj.com.basic.weight.subscaleview.decoder.SkiaImageRegionDecoder;
...
public class SubsamplingScaleImageView extends View {
    ...
    // initiate scale when started
    private float initScale = minScale();
    ...
    private int doubleTapZoomDuration = 350;
    ...
    private void doubleTapZoom(PointF sCenter, PointF vFocus) {
        ...
        boolean zoomIn = scale == initScale;
        float targetScale = zoomIn ? doubleTapZoomScale : initScale;
    ...
    public final void setInitScale(float initScale) {
    ...
    public final void setInitScaleDpi(int dpi) {
        DisplayMetrics metrics = getResources().getDisplayMetrics();
        float averageDpi = (metrics.xdpi + metrics.ydpi) / 2;
        setInitScale(averageDpi / dpi);
    }
    ...
    public final void resetScaleAndCenter() {
        this.anim = null;
        this.pendingScale = limitedScale(initScale);
        if (isReady()) {
            int imageHeight = (int) (sHeight() * initScale);
